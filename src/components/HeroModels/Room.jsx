...
export function Room(props) {
  ...
  color: "#D9D3E5", // Rosa vintage
});

const bodyMaterial = new THREE.MeshPhongMaterial({
  map: matcapTexture,
  color: "#F2F7F7", // Beige cálido aesthetic
});

const tableMaterial = new THREE.MeshPhongMaterial({
  color: "#96A1A9", // Marrón cálido aesthetic
});

const radiatorMaterial = new THREE.MeshPhongMaterial({
  color: "#fdf6ec", // Blanco cálido
});
    ...
    <group {...props} dispose={null}>
      <EffectComposer>
        <SelectiveBloom
          ...
          intensity={1.3} // Strength of the bloom
